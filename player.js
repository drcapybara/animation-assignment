...
class Player {
    ...
    constructor(game, player_type, x, y) {
        ...
        this.jumpAnimation = new Animator(ASSET_MANAGER.getAsset("./assets/characters/washing_machine/opening/washing_machine_sprite_sheet.png"), 0, 0, 800, 800, 20, 0.07, false, true);
        this.defaultAnimation = new Animator(ASSET_MANAGER.getAsset("./assets/characters/washing_machine/walking/washing_machine_walking_sprite_sheet.png"), 0, 0, 800, 800, 10, 0.1, false, true);
